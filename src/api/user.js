...
const normalizePetData = (d) => {
  ...
  return {
    ...
    gender: up(d.gender),                // MALE | FEMALE
    color: d.color?.trim() || null,
    weightKg: toNum(d.weightKg),         // BigDecimal
    ...
    status: up(d.status) || null,        // ACTIVE | INACTIVE | DECEASED
  };
};

// Add new pet with optional image
