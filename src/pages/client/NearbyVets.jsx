        ...
        <section className="product-area section-space">
            <div className="container">
                <div className="section-title text-center">
                    ...
                    <p>Search for veterinarians near your location and book appointments.</p>
                </div>
                ...
                {showSearch ? (
                    ...
                    <div className="results-section">
                        <div className="card border-0 shadow-sm mb-4">
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 className="mb-1">Found {vets.length} veterinarians nearby</h4>
                                        <p className="text-muted mb-0">Search results based on your location</p>
                                    </div>
                                    <button onClick={resetSearch} className="btn btn-outline-primary">
                                        🔍 New Search
                                    </button>
                                </div>
                            </div>
                        ...
                        {vets.length > 0 ? (
                            <div className="row">
                                {vets.map((vet) => (
                                    <VetCard key={vet.userId} vet={vet} onBook={handleBookClick} />
                                ))}
                            </div>
                        ) : (
                                ...
                                <div className="card border-0 shadow-sm">
                                    <div className="card-body py-5">
                                        <div className="mb-4">
                                            ...
                                            <p className="text-muted">Try increasing the search radius or using a different location</p>
                                        </div>
                ...
                <div className="vf-backdrop">
                    <div className="vf-modal p-4 bg-white rounded shadow">
                        ...
                        <div className="mb-2 text-muted small">
                            ...
                            <br />
                            {selectedVet.vetName || 'Unknown Vet'} • {selectedVet.vetPhone || 'N/A'}
                        </div>
                        <form onSubmit={handleBookSubmit}>
                            ...
                            <div className="mb-2">
                                ...
                                <input name="reason" className="form-control" placeholder="Vaccination, Check-up, etc." required />
                            </div>
                            <div className="mb-2">
