...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="dropdowns.html">
              Dropdowns
            </a>
            <a className="collapse-item" href="modals.html">
              Modals
            </a>
            <a className="collapse-item" href="popovers.html">
              Popovers
            </a>
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="form_basics.html">
              Form Basics
            </a>
            <a className="collapse-item" href="form_advanceds.html">
              Form Advanceds
            </a>
          </div>
        </div>
      ...
      <li
        className={`nav-item ${
          isCollapseActive(["/admin/tables"]) ? "active" : ""
        }`}
      >
        <a
          className="nav-link collapsed"
        ...
        <div
          id="collapseTable"
          className={`collapse ${
            isCollapseActive(["/admin/tables"]) ? "show" : ""
          }`}
          ...
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link
              className={`collapse-item ${
                isActive("/admin/tables/simple") ? "active" : ""
              }`}
              to="/admin/orders"
            >
              Order
            ...
            <Link
              className={`collapse-item ${
                isActive("/admin/tables/datatables") ? "active" : ""
              }`}
            ...
            <Link
              className={`collapse-item ${
                isActive("/admin/tables/categories") ? "active" : ""
              }`}
              to="/admin/categories"
            >
              Categories
            ...
            <Link
              className={`collapse-item ${
                isActive("/admin/tables/role-request") ? "active" : ""
              }`}
