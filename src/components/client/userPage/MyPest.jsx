...
export default function MyPest() {
  ...
  const fetchPets = async () => {
    try {
      ...
      setMessage(
        "An error occurred while loading your pets. Please try again later."
      );
  ...
  const validatePetForm = (data) => {
    ...
    if (!isEmpty(data.lastVetVisit)) {
      ...
      if (isNaN(d2.getTime())) e.lastVetVisit = "Invalid visit date";
        ...
        const today = new Date();
        if (d2 > today)
          e.lastVetVisit = "Last vet visit cannot be in the future";
      }
    }
          ...
          <div className="modal-body pt-0">
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <input
                      type="date"
                      className={`form-control ${
                        errors.lastVetVisit ? "is-invalid" : ""
                      }`}
                      value={editForm.lastVetVisit}
                      onChange={(e) =>
                        setEditForm({
                          ...editForm,
                          lastVetVisit: e.target.value,
                        })
                      }
                    />
                    {errors.lastVetVisit && (
              ...
              <div className="d-flex gap-4">
                <div className="form-check mr-4">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, vaccinated: e.target.checked })
                    }
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, sterilized: e.target.checked })
                    }
                  />
            ...
            <div>
              ...
              <div className="form-group mb-3">
                ...
                />
                <small className="text-muted">
                  Supports .jpg, .png images (max ~5MB).
                </small>
              </div>
                              ...
                              <td>
                                <div className="btn-group" role="group">
                                  <button
                                    className="btn btn-sm btn-info"
                                    onClick={() =>
                                      handleViewHealthRecordDetail(record.id)
                                    }
                                    title="View Details"
                                  >
                ...
                <div className="modal-body">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <p>
                        <strong>Date:</strong>{" "}
                        {formatDate(selectedHealthRecord.visitTime)}
                      </p>
                      <p>
                        <strong>Vet:</strong>{" "}
                        {selectedHealthRecord.vetName || "N/A"}
                      </p>
                      <p>
                        <strong>Pet:</strong> {selectedHealthRecord.petName}
                      </p>
                    </div>
                    <div className="col-md-6">
                      ...
                      <p>
                        ...
                        {selectedHealthRecord.diagnosis || "N/A"}
                      </p>
                      <p>
                        <strong>Treatment:</strong>{" "}
                        {selectedHealthRecord.treatment || "N/A"}
                      </p>
                    </div>
                  </div>
                  ...
                  {selectedHealthRecord.documents &&
                    selectedHealthRecord.documents.length > 0 && (
                      <div className="mt-3">
                                  ...
                                  <div className="card-body">
                                    ...
                                    <div className="btn-group" role="group">
                                      ...
                                      <button
                                        className="btn btn-sm btn-danger"
                                        onClick={() =>
                                          handleDeleteHealthDocument(doc.id)
                                        }
