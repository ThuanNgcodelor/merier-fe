  ...
  const handleBookSubmit = async (e) => {
    ...
    if (!petId || !date || !time) {
      await Swal.fire({
        ...
        text: "Please choose your pet, date and time.",
        icon: "warning",
      ...
      await Swal.fire({
        ...
        html: `
          <div style="text-align:left">
            ...
            <div><b>Time:</b> ${date} ${time}</div>
            <div><b>Reson:</b> ${reason || "Vet appointment"}</div>
          </div>
        `,
        icon: "success",
              ...
              <button
                ...
                onClick={async () => {
                  const res = await Swal.fire({
                    ...
                    text: "Information imported will not be saved.",
                    icon: "question",
                    showCancelButton: true,
                    confirmButtonText: "Cancelư",
                    cancelButtonText: "Continue",
                    confirmButtonColor: "#d33",
                  });
                  if (res.isConfirmed) setSelectedVet(null);
                }}
              >
                ✕
              </button>
